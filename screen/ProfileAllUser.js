    ...
    <View style={styles.container}>
      ...
      <View style={styles.containerInfo}>
        <View style={styles.viewTxt}>
          <Icon source={require('../asset/account.png')} size={30} color="#ff1493" />
          <Text style={styles.txt}>User Name: </Text>
          <Text style={styles.txtInfo}>{fullname}</Text>
        </View>
        <View style={styles.viewTxt}>
          <Icon source={require('../asset/email.png')} size={30} color="#ff1493" />
          <Text style={styles.txt}>Email: </Text>
          <Text style={styles.txtInfo}>{email}</Text>
        </View>
        <View style={styles.viewTxt}>
          <Icon source={require('../asset/phone.png')} size={30} color="#ff1493" />
